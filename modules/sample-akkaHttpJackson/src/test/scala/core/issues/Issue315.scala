...
class Issue315Suite extends AnyFunSuite with TestImplicits with Matchers with EitherValues with ScalaFutures with ScalatestRouteTest {
  ...
  object client {
    def legacylegacy(httpClient: HttpRequest => Future[HttpResponse]) = {
      import _root_.issues.issue315.legacylegacy.client.akkaHttpJackson.Client
      import _root_.issues.issue315.legacylegacy.client.akkaHttpJackson.definitions._
      import _root_.issues.issue315.legacylegacy.client.akkaHttpJackson.support.Presence
    ...
    def legacyoptional(httpClient: HttpRequest => Future[HttpResponse]) = {
      import _root_.issues.issue315.legacyoptional.client.akkaHttpJackson.Client
      import _root_.issues.issue315.legacyoptional.client.akkaHttpJackson.definitions._
      import _root_.issues.issue315.legacyoptional.client.akkaHttpJackson.support.Presence
      val clientBody = TestObject(
        required = "foo",
        requiredNullable = None,
        optional = Presence.absent[String],
    ...
    def legacyrequiredNullable(httpClient: HttpRequest => Future[HttpResponse]) = {
      import _root_.issues.issue315.legacyrequiredNullable.client.akkaHttpJackson.Client
      import _root_.issues.issue315.legacyrequiredNullable.client.akkaHttpJackson.definitions._
      import _root_.issues.issue315.legacyrequiredNullable.client.akkaHttpJackson.support.Presence
      val clientBody = TestObject(
        required = "foo",
        requiredNullable = None,
        optional = Presence.absent[String],
    ...
    def optionallegacy(httpClient: HttpRequest => Future[HttpResponse]) = {
      import _root_.issues.issue315.optionallegacy.client.akkaHttpJackson.Client
      import _root_.issues.issue315.optionallegacy.client.akkaHttpJackson.definitions._
      import _root_.issues.issue315.optionallegacy.client.akkaHttpJackson.support.Presence
      val clientBody = TestObject(
        required = "foo",
        requiredNullable = None,
        optional = Presence.absent[String],
    ...
    def optionaloptional(httpClient: HttpRequest => Future[HttpResponse]) = {
      import _root_.issues.issue315.optionaloptional.client.akkaHttpJackson.Client
      import _root_.issues.issue315.optionaloptional.client.akkaHttpJackson.definitions._
      import _root_.issues.issue315.optionaloptional.client.akkaHttpJackson.support.Presence
      val clientBody = TestObject(
        required = "foo",
        requiredNullable = None,
        optional = Presence.absent[String],
    ...
    def optionalrequiredNullable(httpClient: HttpRequest => Future[HttpResponse]) = {
      import _root_.issues.issue315.optionalrequiredNullable.client.akkaHttpJackson.Client
      import _root_.issues.issue315.optionalrequiredNullable.client.akkaHttpJackson.definitions._
      import _root_.issues.issue315.optionalrequiredNullable.client.akkaHttpJackson.support.Presence
      val clientBody = TestObject(
        required = "foo",
        requiredNullable = None,
        optional = Presence.absent[String],
    ...
    def requiredNullablelegacy(httpClient: HttpRequest => Future[HttpResponse]) = {
      import _root_.issues.issue315.requiredNullablelegacy.client.akkaHttpJackson.Client
      import _root_.issues.issue315.requiredNullablelegacy.client.akkaHttpJackson.definitions._
      import _root_.issues.issue315.requiredNullablelegacy.client.akkaHttpJackson.support.Presence
      val clientBody = TestObject(
        required = "foo",
        requiredNullable = None,
        optional = Presence.absent[String],
    ...
    def requiredNullableoptional(httpClient: HttpRequest => Future[HttpResponse]) = {
      import _root_.issues.issue315.requiredNullableoptional.client.akkaHttpJackson.Client
      import _root_.issues.issue315.requiredNullableoptional.client.akkaHttpJackson.definitions._
      import _root_.issues.issue315.requiredNullableoptional.client.akkaHttpJackson.support.Presence
      val clientBody = TestObject(
        required = "foo",
        requiredNullable = None,
        optional = Presence.absent[String],
    ...
    def requiredNullablerequiredNullable(httpClient: HttpRequest => Future[HttpResponse]) = {
      import _root_.issues.issue315.requiredNullablerequiredNullable.client.akkaHttpJackson.Client
      import _root_.issues.issue315.requiredNullablerequiredNullable.client.akkaHttpJackson.definitions._
      import _root_.issues.issue315.requiredNullablerequiredNullable.client.akkaHttpJackson.support.Presence
      val clientBody = TestObject(
        required = "foo",
        requiredNullable = None,
        optional = Presence.absent[String],
